...
- [ ] L1 대상 전수(≈22사) lite JSON + 게이트 PASS + 렌더 스모크 — **3/22 완주**
...
**잔여 14사 = 델타 카드까지 완료, 눈여겨볼 곳만 남음**(매니페스트 미등재 상태로 대기):
중공업방산 11 · 포스코퓨처엠 003670 · HD한국조선해양 009540 · 삼성물산 028260.
카카오 035720은 원천 결함으로 보류(§8).
