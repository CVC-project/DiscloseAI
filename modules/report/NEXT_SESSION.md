...
- **Wave 2 진행 1/8 — 현대제철 004020 완주(08-03, `bd6707d8`·`8c42b68b`)**: 철강 첫 T1. 게이트를 처음부터 켜고 빌드해 **retrofit 라운드 0**(`--strict` 첫 시도 0). 승격 20 + appendix 11 · note_dive 11 · 무핀 0 · accuracy REFUTED 29→0 · completeness PASS. 신규 채록 **V-102**(철강 서사·§13 게이트 첫 신규 발화·rnd를 `II.사업의내용`에서 회수)·**V-103**(리더 지시 — APPENDIX 나브 2줄 접힘 → **amt 7칙 신설**: 라벨+amt ≤ 23자, 카드 제목은 주석 원제목 그대로 쓰지 말 것). **다음 = S-Oil 010950**(2/8).
