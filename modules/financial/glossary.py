...
GLOSSARY: Dict[str, GlossaryEntry] = {
    ...
    "M1": GlossaryEntry(
        ...
        how="3년 누적 영업활동현금흐름(OCF) ÷ 3년 누적 영업이익. 비율 × 100 = 점수(0~100 클립).",
        benchmark="100+ 우량 (이익=현금) / 80 양호 / 50↓ 주의 / 0 이하 적신호",
        intuition="장부 이익이 실제 현금으로 들어왔는지를 본다. 외상·재고가 쌓이면 비율이 떨어진다.",
    ),
    "M2": GlossaryEntry(
        label="M2 매출 회수 건전성",
    ...
    "M3": GlossaryEntry(
        ...
        how="업종별 임계값으로 선형 보간 — IT/SW는 30~250%, 제조업은 50~400%, 건설은 100~600%, 은행은 800~2500%. 자본집약 업종일수록 임계값이 완화됨.",
        benchmark="해당 업종 양호선(80점) 이내가 정상. 자본잠식(자본 ≤ 0)은 0점 + 상장폐지 사유.",
    ...
    "M5": GlossaryEntry(
        ...
        how="(자본총계[t] ÷ 자본총계[t-2])^(1/2) − 1 = CAGR. 점수 = 50 + CAGR×500 (클립 0~100). +10%/yr → 100점, 0%/yr → 50점, -10%/yr → 0점.",
        benchmark="+5%/yr↑ 양호 / 0%/yr 정체 / 마이너스는 자본 감소(자사주 소각·배당 환원 포함)",
