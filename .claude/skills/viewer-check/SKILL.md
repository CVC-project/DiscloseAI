...
- viewer/index.html (또는 다른 모듈의 프론트엔드)을 수정하고 **브라우저 확인 전에** 누락·미동작 여부를 Claude 쪽에서 먼저 잡고 싶을 때
...
`.claude/skills/viewer-check/SKILL.md`는 프로젝트 루트에서 `/viewer-check` 로 호출 가능.
